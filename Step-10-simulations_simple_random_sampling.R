...
mean_base=c(first_mix[1:3],mu_d,mu_s,Sens,TPM[1,1:3],TPM[2,1:3],TPM[3,1:3],TPM[4,1:3]) ##### check the value of r and take only those parameters returned
mean_base<-as.numeric(mean_base)
mean_base=mean_base[-r]
